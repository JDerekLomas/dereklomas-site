...
export function SiteSchema() {
  const person = {
    ...
    name: "Derek Lomas",
    url: BASE_URL,
    jobTitle: "Tenured Assistant Professor",
    worksFor: {
      "@type": "Organization",
      name: "TU Delft",
  ...
  const website = {
    ...
    name: "Derek Lomas",
    description:
      "Assistant Professor at TU Delft researching Positive AI. Enhancing wellbeing through AI, education, and humanistic design.",
