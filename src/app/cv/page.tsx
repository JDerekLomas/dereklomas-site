...
export const metadata: Metadata = {
  ...
  description:
    "Academic CV — J. Derek Lomas, PhD. Professor of Positive AI at TU Delft.",
};
...
const talks = [
  ...
  { year: "2025", venue: "Stanford EEG Topics Seminar", title: "Neural Resonance in Aesthetic Experiences" },
  { year: "2025", venue: "Amsterdam Dance Event (ADE)", title: "Speaker / artist" },
  { year: "2024", venue: "Dutch Design Week 2024, Eindhoven", title: "AI and Creativity (Design Academy Eindhoven)" },
  { year: "2024", venue: "TU Delft", title: "AI & Experience Design Conference — keynote" },
  { year: "2024", venue: "Het Landjuweel Festival, Ruigoord, Amsterdam", title: "Talk on AI, resonance, and design" },
  { year: "2024", venue: "Mo:Dem Festival, Croatia", title: "Talk on resonance and AI" },
  { year: "2024–present", venue: "TU Delft IDE (open-enrollment)", title: "Designing with AI — Professional Master Class (ASML, Silver Cross, ABN Amro)" },
  { year: "2022", venue: "Experience Research Summit, Salt Lake City / Provo", title: "Design Resonance" },
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <header className="mb-12 print:mb-8">
          ...
          <p className="text-text-secondary text-lg mb-4">
            Professor of Positive AI · TU Delft, Industrial
