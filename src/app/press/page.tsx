...
const pressItems = [
  {
    ...
    date: "Dec 2025",
    url: "https://www.linkedin.com/posts/smartpaper_15-million-mcq-worksheets-scanned-in-5-days-activity-7404763318474833920-li2c",
    type: "Venture" as const,
    note: "Half-yearly state assessment, 5M students across 65,000 schools, 80% time saved",
  },
  {
  ...
  {
    title: "Gujarat Startup's AI Transforms Rajasthan School Assessment",
    outlet: "Gandhinagar Samachar (Gujarati)",
    date: "Nov 2025",
    url: "https://www.linkedin.com/posts/nirmalpatelai_excited-to-get-featured-in-gujarati-newspaper-activity-7386266621054455808-wWK7",
    type: "Venture" as const,
    note: "Print feature on Smart Paper pilot in Jodhpur district, 3,000+ teacher hours saved",
  },
  {
    title:
  ...
  {
    title: "Smart Paper wins Aegis Graham Bell Award for Innovation in AI for Education",
    outlet: "Aegis Graham Bell Awards",
    date: "2024",
    url: "https://bellaward.com/",
    type: "Award" as const,
    note: "India's largest innovation awards — Innovation in AI for Education",
  },
  {
    title: "Smart Paper named winner — UNESCO AI in Learning Assessment Challenge",
    outlet: "UNESCO",
    date: "2024",
    url: "https://www.unesco.org/",
    type: "Award" as const,
    note: "Smart Paper / EdOptimize / Playpower Labs",
  },
  {
